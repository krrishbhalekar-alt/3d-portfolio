    ...
    >
      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-left">
          ...
          {/* Tagline */}
          <p className="reveal opacity-0 text-base md:text-lg text-muted-foreground/80 max-w-xl mb-12 leading-relaxed delay-400 text-pretty">
        ...
        <div className="md:w-1/2 flex justify-center">
          <img
            src="/profile.png"
            alt="Soham Bhalekar"
            className="w-[260px] md:w-[340px] rounded-full"
          />
        </div>
      </div>
